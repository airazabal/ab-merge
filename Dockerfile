...
#ES-10
ENTRYPOINT ["java", "-Djavax.net.ssl.trustStoreType=pkcs12", "-Djavax.net.ssl.trustStore=/deployments/configuration/es-cert.p12", "-Djavax.net.ssl.trustStorePassword=xmNQ0GbZTByB", "-jar", "./kstreams-merge-standalone-0.0.1.jar", "./configuration/es10-cluster.properties"]
